# Klick setzt den Textcursor — wie es funktioniert

> Terminal-Maus allgemein — Modi, SGR-Format, Button-Codes, Aufräumpflicht —
> steht in `MOUSE-CLICK.md`. Diese Datei beschreibt den Sonderfall darauf:
> den Klick, der in Kimis Eingabefeld den Textcursor versetzt.
