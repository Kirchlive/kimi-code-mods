<!--
source: ../../packages/agent-core/src/tools/builtin/file/read.md
module: read_default$1
variant: mustache
chars: 2391
bundleOffset: 6043077
-->
...
- Mixed or lone carriage-return line endings are shown as `\` and require exact `Edit.old_string` escapes.
