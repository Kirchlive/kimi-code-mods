<!--
source: ../../packages/agent-core/src/tools/builtin/file/edit.md
module: edit_default$1
variant: plain
chars: 1256
bundleOffset: 5833450
-->
...
- For mixed endings or lone carriage returns, Read shows carriage returns as \; include actual \ escapes in those positions.
