...
const ACTIVE = {
  ...
  'cron_drop_dir': 'on',
  // `immediate` rather than `always`: it is the superset — the stopTurn
  // splices in 86 and 87 only run in that mode, and an anchor that drifts
  // there is invisible in any weaker setting.
  'agent_background': 'immediate',
  'agent_dock': 'all',
};
